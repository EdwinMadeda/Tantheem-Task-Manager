...
const SingleProject = () => {
  ...
  return (
    <section className="SingleProject main">
        <div className="SingleProject__Container top">
            <BackBtn path="/myprojects"/>
            <div className="SingleProject__InnerContainer">
                <h2 className="SingleProject__Title">{selectProject.name}</h2>
                <ProgressBar 
        ...
        <div className="SingleProject__Container bottom">
            <div className="SingleProject__InnerContainer">
                <h3 className="ProjectDeliverables__Title">To Do</h3>
                <ProjectDeliverables 
            ...
            <div className="SingleProject__InnerContainer">
                <h3 className="ProjectDeliverables__Title">In Progress</h3>
                <ProjectDeliverables 
            ...
            <div className="SingleProject__InnerContainer">
                <h3 className="ProjectDeliverables__Title">Completed</h3>
                <ProjectDeliverables 
