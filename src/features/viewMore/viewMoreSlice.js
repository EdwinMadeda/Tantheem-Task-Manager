...
export const selectViewMorePreviousWork = state => state.viewMore.TasksPreviousWork;
...
export const { setViewMoreTasksToDo, setViewMorePreviousWork, setViewMoreTeamsToDo} = viewMoreSlice.actions;
